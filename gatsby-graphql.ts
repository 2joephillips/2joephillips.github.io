...
export type Site_Index_QueryQueryVariables = {};
...
export type PostNodeQueryVariables = {};


export type PostNodeQuery = { allMdx: { nodes: Array<{ fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title'>> }> } };
